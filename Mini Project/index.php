			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 text-right">
						<p class="site">www.kgkids.com</p>
						<p class="num">Call: +91 8954600038</p>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					<h2>Our Course</h2>
					<p>We offer diifferent kinds of courses which are given below</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							<h3><a href="#">Math Fundamentals</a></h3>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							<h3><a href="#">Character Building</a></h3>
		...
		<div class="container">
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						<small class="block">&copy; 2021 Free All Rights Reserved.</small> 
						<small class="block">Designed by <br> Vivek Kumar </br> <br> Ravindra Singh </br>
						<br> Rajeshwar Sharma </br>
						<br> Rajan Sharma </br>
						<br> Shivam Mishra </br> 
						</small>
					</p>
