...
<html>
    ...
    <body>
        ...
        <?php
        $fetchVideos = mysqli_query($conn, "SELECT * FROM character_building ORDER BY id DESC");
        while($row = mysqli_fetch_assoc($fetchVideos)){
            $location = $row['location'];
            echo"<h1 style='font-weight:bold;font-size:30px;text-align:center;'>Character Building Videos </h1>";
            echo "<div >";
